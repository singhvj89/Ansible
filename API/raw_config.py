...
# Declare the variable (string) for the URL of leaf2-DC2

url = "https://192.168.0.32/command-api"
...
r = requests.post(url, auth=('arista','aristaqlng'), data=commands, verify=False) 
